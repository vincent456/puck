...
//        |} """
//    ){
//      graph.typeConstraints("p.B.la2") should contain (("p.B.la1", "p.A") : NodeIdP)
//    }
//  }
//
...
//
//    graph.nodesThatShouldBeASupertypeOf("p.B.wa") should contain ("p.B.assignA().Definition.a" : NodeId)
//  }
//
...
//
//      graph.nodesThatShouldBeASupertypeOf("p.C.is") should contain (methodTypeUse)
//
//    }
//  }
//
