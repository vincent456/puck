...
node('root.scope_b.sub_scope_a0',object, 'sub_scope_a0').
node('root.scope_b.sub_scope_b',object, 'sub_scope_b').
node('root.scope_b.sub_scope_a0',object, 'sub_scope_a0').
...
edge(uses, 'root.scope_b.sub_scope_b', 'root.scope_b.sub_scope_a0').
edge(contains, 'root.scope_b', 'root.scope_b.sub_scope_b').
edge(contains, 'root.scope_b', 'root.scope_b.sub_scope_a0').
