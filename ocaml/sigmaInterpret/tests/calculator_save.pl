...
node('root.calculator.equals.s.arg',object, 'arg').
node('root.calculator.equals.s',object, 's').
node('root.calculator.equals',object, 'equals').
node('root.calculator.add.s.acc',object, 'acc').
node('root.calculator.add.s.equals',object, 'equals').
node('dynamic1.equals',object, 'dynamic1.equals').
node('root.calculator.add.s2.arg',object, 'arg').
node('root.calculator.add.s2.acc',object, 'acc').
node('root.calculator.add.s2',object, 's2').
node('root.calculator.add.s',object, 's').
node('root.calculator.add',object, 'add').
node('root.calculator.enter.s.arg',object, 'arg').
...
edge(uses, 'root.calculator.equals', 'root.calculator.equals.s.arg').
edge(contains, 'root.calculator.equals', 'root.calculator.equals.s').
edge(contains, 'root.calculator', 'root.calculator.equals').
edge(uses, 'root.calculator.add', 'root.calculator.add.s.acc').
edge(uses, 'root.calculator.add', 'root.calculator.add.s.equals').
edge(uses, 'root.calculator.add', 'dynamic1.equals').
edge(uses, 'root.calculator.add', 'root.calculator.add.s2.arg').
edge(uses, 'root.calculator.add', 'root.calculator.add.s2.acc').
...
edge(uses, 'root.calculator.enter', 'root.calculator.enter.s.arg').
