...
node('root.scope_b.interloper.sub_interloper', 'sub_interloper').
...
contains('root.scope_b.interloper', 'root.scope_b.interloper.sub_interloper').

uses('root.scope_b.interloper', 'root.scope_a.sub_scope_a0').
uses('root.scope_b.interloper.sub_interloper', 'root.scope_a.sub_scope_a0').
...
%hideFrom('root.scope_a.sub_scope_a0', 'root.scope_b.sub_scope_b').
